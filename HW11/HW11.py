...
class University:
    ...
    """
    def __init__(self, path: str, table=False) -> None:
        self.path: str = path
        self.students: dict = {}
        ...
        if table:
            ...
            self.student_grades_table_db(path + '/HW11.db')
    ...
    def student_grades_table_db(self, db_path: str) -> PrettyTable:
        try:
            ...
            student_grades_table: PrettyTable = PrettyTable(field_names=['Name', 'CWID', 'Course', 'Grade', 'Instructor'])

            for row in db.execute(dbscripts):
                student_grades_table.add_row(row)

            print(student_grades_table)
            return student_grades_table


def main() -> None:
    path: str = '/Users/yaoyuchen/Documents/SSW810/HWK&ASMT/HW11'
    University(path, table=True)
